...
/*GrayScale coversion
We will use Luminosity Method
We take a weighted average of the components where the contribution of blue to the final value should decrease, and the contribution of green should increase. After experiments and more in-depth analysis, researchers have concluded in the equation below:
...
int main(int argc, char** argv)
{
	...
	//Change background to gray scale
	float gray = toGrayscale(0.8f, 0.1f, 0.2f); //Convert the original background color to grayscale
