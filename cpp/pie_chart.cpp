...
//Create chart object 
PieChart chart({
    {"Orange", 41, 0.88f, 0.49f, 0.23f},
    {"Avocado", 36, 0.20f, 0.40f, 0.68f},
    {"Mango", 30, 0.56f, 0.36f, 0.73f},
    {"Kiwi", 28, 0.79f, 0.30f, 0.49f},
    {"Banana", 19, 0.23f, 0.67f, 0.43f},
    {"Grapes", 16, 0.30f, 0.72f, 0.77f}
    });
